...
const rumberOfSeconds = minutesToSeconds(1);
console.log(rumberOfSeconds);
...
function merge(firstString, secondSString) {
...
const myDog = calculateDogYears(25);
console.log(myDog);
